    ...
    try {
        if (await checkRegistUser(orderId, id)) {
            ...
            if (work.paymentType === 0) {
                ...
                const registUserPointBreakdown =
                    await prisma.pointBreakdown.create({
                        data: {
                ...
                const acceptUserPointBreakdown =
                    await prisma.pointBreakdown.create({
                        data: {
                ...
                if (
                    ...
                    if (recommendUserPoint !== null) {
                        const updateRecommendUserPoint =
                            await prisma.point.update({
                                where: {
                                    userId: recommendUser.recommendUserId,
                                },
                                data: {
                                    curPoint:
                        ...
                        const recommendUserPointBreakdown =
                            await prisma.pointBreakdown.create({
                                data: {
                                    ...
                                    restPoint:
                                        updateRecommendUserPoint.curPoint,
                                    user: {
                                        connect: {
